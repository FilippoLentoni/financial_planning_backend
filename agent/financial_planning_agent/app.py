...
@tool
def get_model_input(run_id: str) -> dict[str, Any]:
    """Return the model input payload used for a portfolio optimization run."""
    return _invoke_tool_lambda("get_model_input", {"run_id": run_id})


@tool
def get_model_output(run_id: str) -> dict[str, Any]:
    """Return the model output payload generated by a portfolio optimization run."""
    return _invoke_tool_lambda("get_model_output", {"run_id": run_id})
...
@tool
def get_model_formulation(run_id: str) -> dict[str, Any]:
    """Return the synthetic math-model formulation for a portfolio optimization run."""
    return _invoke_tool_lambda("get_model_formulation", {"run_id": run_id})
...
@tool
def override(input_id: str, justification: str) -> dict[str, Any]:
    """Record a governed manual override decision for a model input."""
    return _invoke_tool_lambda("override", {"input_id": input_id, "justification": justification})
